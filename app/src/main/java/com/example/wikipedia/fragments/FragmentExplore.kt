...
import com.example.wikipedia.adaptors.ExploreAdaptor
import com.example.wikipedia.adaptors.ItemEvents
import com.example.wikipedia.adaptors.TrendAdaptor
...
class FragmentExplore : Fragment(), ItemEvents {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val myAdaptor = ExploreAdaptor(dataExplore, this)
        binding.recyclerExplore.layoutManager =
            LinearLayoutManager(context, RecyclerView.VERTICAL, false)
        binding.recyclerExplore.adapter = myAdaptor
    }
